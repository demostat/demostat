...
def demos(response):
    ...
    return render(request, 'demostatapp/demos_list.html', {'demo_list': demo_list})
...
def demos_year(request, date__year):
    ...
    return render(request, 'demostatapp/demos_year_list.html', {'date': datetime.date(int(date__year), 1, 1), 'demo_list': demo_list, 'demo_prev': demo_prev, 'demo_next': demo_next})
...
def demos_month(request, date__year, date__month):
    ...
    return render(request, 'demostatapp/demos_month_list.html', {'date': datetime.date(int(date__year), int(date__month), 1), 'demo_list': demo_list, 'demo_prev': demo_prev, 'demo_next': demo_next})
...
def tag(request, tag_slug):
    ...
    return render(request, 'demostatapp/tag_detail.html', {'tag_slug': tag_slug, 'tag_name': tag_name, 'demo_list': demo_list})
